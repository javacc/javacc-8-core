...
public final class JJTreeOptionsTest extends TestCase {
  ...
  public void testOutputDirectory() {
    ...
    Options.processGrammarFileOption(null, null, Options.UO__OUTPUT_DIRECTORY, "test/output", context);
    ...
    Options.processGrammarFileOption(null, null, "JJTREE_OUTPUT_DIRECTORY", "test/jjtreeoutput", context);
    assertEquals(new File("test/output"), JJTreeOptions.getOutputDirectory());
  ...
  public void testNodeFactory() {
    ...
    assertEquals(0, context.errors().get_warning_count());
    assertEquals(0, context.errors().get_error_count());
    JJTreeOptions.processGrammarFileOption(null, null, "NODE_FACTORY", Boolean.FALSE, context);
    assertEquals(context.treeOptions().getNodeFactory(), "");

    context = new JJTreeContext();
    JJTreeOptions.processGrammarFileOption(null, null, "NODE_FACTORY", Boolean.TRUE, context);
    assertEquals(context.treeOptions().getNodeFactory(), "*");

    context = new JJTreeContext();
    JJTreeOptions.processGrammarFileOption(null, null, "NODE_FACTORY", "mypackage.MyNode", context);
  ...
  public void testValidate() {
    ...
    JJTreeOptions.processCmdLineOption("VISITOR_DATA_TYPE=Object");
    context.validate();
    ...
    JJTreeOptions.processCmdLineOption("VISITOR_DATA_TYPE=Object");
    JJTreeOptions.processCmdLineOption("VISITOR=true");
    context.validate();
    assertEquals(0, context.errors().get_warning_count());
  ...
  public void testValidateReturnType() {
    ...
    JJTreeOptions.processCmdLineOption("VISITOR_DATA_TYPE=String");
    context.validate();
    assertEquals(1, context.errors().get_warning_count());
